...
The license of this project is available in [LICENCE](LICENSE) file. Shortly, it is the MIT license, which allows you to use this project in any way you want, except for claiming it as your own.
